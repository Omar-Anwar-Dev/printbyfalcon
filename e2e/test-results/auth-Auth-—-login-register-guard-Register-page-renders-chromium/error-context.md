...
- Name: auth.spec.ts >> Auth — login / register / guard >> Register page renders
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e29]:
      - generic [ref=e30]:
        ...
        - main [ref=e43]:
          - generic [ref=e46]:
            - paragraph [ref=e47]: № 02 · NEW MEMBER
            - heading "Join the atelier" [level=1] [ref=e48]
            - paragraph [ref=e49]: A single minute to create your account.
            - generic [ref=e50]:
              - generic [ref=e51]:
                - generic [ref=e52]:
              ...
              - generic [ref=e58]:
                ...
                - textbox [ref=e60]
              - generic [ref=e61]:
                - generic [ref=e62]: Phone (optional)
                - textbox "+20 10 1234 5678" [ref=e63]
              - generic [ref=e64]:
                - generic [ref=e65]: Password
                - textbox "Min. 8 characters" [ref=e66]
    ...
    - contentinfo [ref=e71]:
      - generic [ref=e72]:
        - heading "PrintbyFalcon" [level=2] [ref=e74]
        - generic [ref=e75]:
          - generic [ref=e76]:
            - paragraph [ref=e77]: Printing Atelier
            - paragraph [ref=e78]: A specialist supplier of genuine printing consumables in Egypt. Serving offices, designers, and studios since 2025.
          - generic [ref=e79]:
            ...
            - list [ref=e81]:
              - listitem [ref=e82]:
                - link "All Products" [ref=e83] [cursor=pointer]:
                  - /url: /en/products
              - listitem [ref=e84]:
                - link "Ink" [ref=e85] [cursor=pointer]:
                  - /url: /en/products?category=ink-cartridges
              - listitem [ref=e86]:
                - link "Printers" [ref=e87] [cursor=pointer]:
                  - /url: /en/products?category=printers
              - listitem [ref=e88]:
                - link "Paper" [ref=e89] [cursor=pointer]:
                  - /url: /en/products?category=paper-media
          - generic [ref=e90]:
            - paragraph [ref=e91]: Account
            - list [ref=e92]:
              - listitem [ref=e93]:
              ...
              - listitem [ref=e99]:
                - link "Support" [ref=e100] [cursor=pointer]:
                  - /url: /en/support
        - generic [ref=e101]:
          - generic [ref=e102]: © 2026 · PRINTBYFALCON · CAIRO, EGYPT
          - generic [ref=e103]:
            - generic [ref=e104]: EST. 2025
            - generic [ref=e105]: ✦
            - generic [ref=e106]: info@printbyfalcon.com
  - alert [ref=e107]
```
