...
- Name: catalog.spec.ts >> Catalog >> Related Products section on detail page
- Location: tests\catalog.spec.ts:38:7
...
Locator: getByRole('heading', { name: /Compatible Products/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Compatible Products/i })
